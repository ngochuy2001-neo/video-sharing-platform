...
import { Search, Upload, Menu, Home, TrendingUp, Clock, ThumbsUp, Settings, LogOut, User } from "lucide-react"
            ...
            <Sheet>
              ...
              <SheetContent side="left" className="w-64">
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <Link href="/trending" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-accent">
